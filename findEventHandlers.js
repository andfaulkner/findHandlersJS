...
module.exports = (function(_, $) {
    ...
    var isNotEmpty = function(someArr) {
        if (!someArr || typeof someArr === 'undefined' || typeof someArr === 'null' ||
                someArr === null) {
            return false;
        }
        return !!((someArr.length) && (someArr.length >= 1));
    };
    ...
    isEventHandlersEmpty = function(eventType, jqSelector) {
          return (isNotEmpty(findEventHandlers(eventType, jqSelector)));
    };
